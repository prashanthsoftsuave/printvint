...
{
    use PostGrid, SidebarCTA, PrimaryNav, SearchPreview;
	...
	public function sidebar_cta() {
		$sidebarCTA = isset(get_field('sidebar_cta')['button_text']) ? get_field('sidebar_cta') : get_field('sidebar_cta', 'options');
