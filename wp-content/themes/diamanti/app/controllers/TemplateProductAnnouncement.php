...
class TemplateProductAnnouncement extends Controller implements Tree
{

    use NewHero, ProductsInformation, ProductSectionMenu, NewCtaBlock, Benefits, ProductFeatures;
    /**
