				...
				<th><?php _e( 'Eloqua Notes', 'gfeloqua' ); ?>
					<?php if ( ! $success ) : ?>
						<span class="gfeloqua-right">
							<strong class="gfeloqua-retries<?php echo esc_attr( $limit_reached ); ?>"><?php _e( 'Retries:', 'gfeloqua' ); ?> <span><?php echo $retry_attempts; ?></span>/<?php echo $retry_limit; ?></strong>
