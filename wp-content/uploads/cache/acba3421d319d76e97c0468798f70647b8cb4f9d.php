<?php if(!get_field('show_in_new_template')): ?>
            ...
            <div class="row single-header">
                <div class="col-md-10">
                  ...
                  <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php  $term_color = get_field('color', 'term_' . $term->term_id);  ?>
                    <div class='resource-label' <?php if($term_color): ?>style="color: <?php echo $term_color; ?>"<?php endif; ?>><?php echo $term->name; ?></div>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="entry-content mt-4">
                    <?php (the_content()); ?>
                  <?php if(!get_field('gate_this_asset')): ?>
                    <?php if( get_field('attached_media')['url'] ): ?>
                      <p>
                        <a class="link-arrow" href="<?php echo e(get_field('attached_media')['url']); ?>"><?php echo e(get_field('link_text')); ?></a>
                      </p>
                    <?php endif; ?>
                  <?php endif; ?>
                </div>
            ...
            <div class="col-md-5 sidebar">
              <?php if(get_field('gate_this_asset')): ?>
                <section class="section form bg-primary light p-4">
                  <?php echo get_field('title_and_description'); ?>

                  <?php echo gravity_form( get_field('choose_a_form'), false, false, false, false, true, 30, true ); ?>

                </section>
              <?php endif; ?>
			  
			   <?php if(get_field('use_marketo_form')): ?>
                <section class="section form bg-primary light p-4 marketo_form_sidebar">
                  <?php echo get_field('marketo_form_embed_code'); ?>
...
<div class="wrap container-fluid p-0" role="document">
            <div class="content">
                <main class="main">
                    <section class="Banner" style="background-image:url(<?php echo get_field('header_background_image')['url'] ?? 'https://go.diamanti.com/rs/597-VSX-966/images/6.png'; ?>)">
                                    ...
                                    <p><strong>
                                      <?php ($terms = get_the_terms('', 'media') ?? ''); ?>
                                        <?php if($terms): ?>
                                          <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <?php  $term_color = get_field('color', 'term_' . $term->term_id);  ?>
                                          <div class='resource-label' style="color:#fff"><?php echo $term->name; ?></div>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </strong></p>
                                    <h1 style="text-transform: uppercase;"><?php echo e(get_the_title()); ?></h1>
                                    <p><?php echo e(get_field('webinar_date_text')); ?></p>
                                  </div>
                            </div>
                        </div>
                    </section>
                    <section class="section1">
                        ...
                        <?php ($classes = (get_field('gate_this_asset') || get_field('use_marketo_form')) ? 'col-sm-7 col-xs-12 padleft' : 'col-xs-12'); ?>
                            <div style="position:relative;" class="<?php echo e($classes); ?>">
                                <?php (the_content()); ?>
                                <?php if(!get_field('gate_this_asset')): ?>
                                  <?php if( get_field('attached_media')['url'] ): ?>
                                    <p>
                    ...
                    <?php if(get_field('show_speakers')): ?>
                      <section class="section">
                      <h4 class="speaker_title"><?php echo get_field('speaker_title'); ?></h4>
                      <?php ($cards = get_field('speaker_sections')); ?>
                      <div class="cta-cards container mb-5">
                        <div class="card-deck">
                          <?php $__currentLoopData = $cards['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="box">
                                <img src="<?php echo e($card['icon']['url'] ?? ""); ?>" alt="<?php echo e($card['icon']['alt'] ?? ""); ?>">
...
<?php if($contact_section['new_cta_block']['button']): ?>
