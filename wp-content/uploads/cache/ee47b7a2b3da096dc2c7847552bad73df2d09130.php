<div class="newSection__header">
    <?php if(isset($data['section_title']) && $data['section_title']): ?><h3><?php echo $data['section_title']; ?></h3><?php endif; ?>
    <?php if(isset($data['title']) && $data['title']): ?><h2><?php echo $data['title']; ?></h2><?php endif; ?>
    <?php if(isset($data['caption']) && $data['caption']): ?><p><?php echo $data['caption']; ?></p><?php endif; ?>
</div>
